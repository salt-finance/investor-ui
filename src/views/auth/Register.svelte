...
<div
  class="flex content-center items-center justify-center w-full"
>
  <div class="relative flex-wrap flex flex-col bg-white rounded-lg py-20 min-h-500 px-10 flex-auto lg:flex-1 w-full gap-4 glass-effect bg-opacity-80 text-neutral-800">
