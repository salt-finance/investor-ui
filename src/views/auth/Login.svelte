<script lang='ts'>
  ...
  // core components
  const github = "https://salt-finance.github.io/investor-ui/assets/img/github.svg";
  const google = "https://salt-finance.github.io/investor-ui/assets/img/google.svg";
  ...
  <div class="flex content-center items-center justify-center h-full">
    <div class="w-full lg:w-4/12 px-4">
      ...
      <div class="flex flex-wrap mt-6 relative">
        <div class="w-1/2">
          <a href="#pablo" on:click={(e) => e.preventDefault()} class="text-neutral-200">
            <small>Forgot password?</small>
          </a>
        </div>
        <div class="w-1/2 text-right">
          <a use:link href="/auth/register" class="text-neutral-200">
