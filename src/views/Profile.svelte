        ...
        >
          <div class="px-6">
              ...
              <div class="w-full lg:w-4/12 px-4 lg:order-1">
                <div class="flex justify-center py-4 lg:pt-4 pt-8">
                  <div class="mr-4 p-3 text-center">
                    ...
                    <span class="text-sm text-slate-500">Friends</span>
                  </div>
                  <div class="mr-4 p-3 text-center">
                    <span
                      class="text-xl font-bold block uppercase tracking-wide text-slate-600"
            ...
            <div class="text-center mt-12">
              ...
              <div
                class="text-sm leading-normal mt-0 mb-2 text-slate-500 font-bold uppercase"
              >
                <i class="fas fa-map-marker-alt mr-2 text-lg text-slate-500"></i>
                Los Angeles, California
              </div>
              <div class="mb-2 text-slate-600 mt-10 skiptranslate">
